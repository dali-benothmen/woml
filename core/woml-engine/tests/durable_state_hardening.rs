...
#[test]
#[ignore]
fn durable_state_process_worker() {
...
#[test]
fn state_operation_latency_and_size_stay_within_release_budgets() {
  ...
  println!(
    "state benchmark: operations={OPERATIONS}, valueBytes={VALUE_BYTES}, p95Ms={p95:.3}, databaseBytes={database_bytes}"
  );
  assert!(
    p95 < P95_BUDGET_MS,

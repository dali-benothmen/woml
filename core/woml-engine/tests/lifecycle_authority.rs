...
fn started_store() -> DurableEventStore {
  ...
  // These  authority tests isolate cancellation/outcome admission.  // separately verifies automatic run-start hook admission and execution.
  workflow
    .lifecycle
    .as_mut()
    .unwrap()
...
#[test]
fn model_v11_maps_to_event_v10_while_current_store_is_v14() {
...
#[test]
fn store_v10_migrates_through_v11_v12_v13_to_v14_and_rebuilds_summaries() {

...
Status: frozen in N0 and implemented through the N4 deterministic provider
journey. Real Slack Socket Mode remains N5.
...
versioned Bun provider host and deterministic Slack conformance adapter.

...
// T9 reaches the complete transitive release gate. N6 rebuilds the native
// package and runs every Rust target and isolated CLI test, including T10.
await import('./verify-t9.ts');

...
for (const [file, required] of [
  ...
  [
    'woml-cli/tests/wc7_workflow-calls-release.test.ts',
    'clean consumer runs a parent and child',
  ],
  [
    'woml-cli/scripts/benchmark-wc7-workflow-calls.ts',
...
const benchmark = Bun.spawn(
  [
    Bun.which('bun')!,
    resolve(cliRoot, 'scripts/benchmark-wc7-workflow-calls.ts'),
    '--iterations',
    '1',
    '--warmup',
    '0',

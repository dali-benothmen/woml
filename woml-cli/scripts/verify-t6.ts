...
// T5 owns the previous complete production-trigger gate. Its full isolated
// frontend/Rust/CLI suite now also includes the T6 shared-transport and approval
// compatibility tests.
await import('./verify-t5.ts');

...
const requiredMarkers = new Map<string, readonly string[]>([
  ['docs/language-reference.md', ['<fork>', 'contains one or more direct, non-empty `<branch>`', 'join="none"', 'Model v13', 'Event v12', 'forkDistributionWorkflow.woml']],
  ['docs/architecture.md', ['N-API']],
  ['docs/protocols/script-host-v1.md', ['fail-closed policy']],
  ['examples/README.md', ['Concurrent multi-step routes and joins', 'forkDistributionWorkflow.woml']],
]);

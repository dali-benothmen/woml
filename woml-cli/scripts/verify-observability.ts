...
for (const [file, required] of [
  ...
  ['woml-cli/tests/fixtures/production-runtime/runtime-snapshot.v1.json', 'runtime_observability'],
] as const) {
...
const surfaces = await Promise.all(
  [
    ...
    'woml-cli/tests/fixtures/production-runtime/runtime-snapshot.v1.json',
    'woml-cli/tests/fixtures/production-runtime/runtime-log.v1.json',
    'woml-cli/tests/fixtures/production-runtime/runtime-metrics.prom',

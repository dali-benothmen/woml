...
// T11 reaches the complete transitive release gate. N6 rebuilds the native
// package and runs every Rust and isolated CLI test, including T12 fan-out.
await import('./verify-t11.ts');

...
const required = new Map([
  ...
  ['woml-cli/tests/pro9-production-release.test.ts', ['a clean consumer installs, activates, serves, observes, backs up, stops, restores, and prunes']],
...
if (
  ...
  throw new Error('woml-cli package metadata is not publishable as Production Runtime v1.');
}
const distBytes = (
  await Promise.all(

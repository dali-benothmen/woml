...
function writer(): string {
  return `<woml>
<workflow id="ds4-packaged-contention" name="DS4 packaged contention" version="1.0.0">
...
const reader = `<woml>
<workflow id="ds4-packaged-contention" name="DS4 packaged reader" version="1.0.0">
  <triggers><manual id="start" /></triggers>
...
describe('DS4 packaged CLI contention', () => {
